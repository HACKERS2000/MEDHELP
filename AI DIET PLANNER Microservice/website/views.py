...
def buy(request):
    ...
    filename = r"/home/jishnusaurav/Downloads/AI DIET PLANNER Microservice/website/csvfile/recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        filename = r"/home/jishnusaurav/Downloads/AI DIET PLANNER Microservice/website/csvfile/recent_activity.csv"
        filename2 = r"/home/jishnusaurav/Downloads/AI DIET PLANNER Microservice/website/csvfile/recent_activity.csv"
